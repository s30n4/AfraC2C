...
namespace AC2C.Dtos.Identity
{
    public class RegisterDto
    {
        ...
        [Remote("ValidateUsername", "Register",
            AdditionalFields = nameof(Email) + "," + DtoConstants.AntiForgeryToken, HttpMethod = "POST")]
        ...
        [Required(ErrorMessage = "(*)")]
        [Remote("ValidateUsername", "Register",
            AdditionalFields = nameof(Username) + "," + DtoConstants.AntiForgeryToken, HttpMethod = "POST")]
