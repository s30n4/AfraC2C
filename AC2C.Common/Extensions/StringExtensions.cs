using System;
using AC2C.Common.SecurityToolkit;

namespace AC2C.Common.Extensions
{
    public static class StringExtensions
    {
        ...
        public static long GetInt64(this string str)
        {
            ...
            Int64.TryParse(GetString(str), out result);
        ...
        public static long? GetInt64Nullable(this string str)
        {
            ...
            var ok = Int64.TryParse(GetString(str), out result);
        ...
        public static long? GetLongNullable(this string str)
        {
            ...
            return string.IsNullOrWhiteSpace(strLong) ? (long?)null : Int64.Parse(strLong);
        }
